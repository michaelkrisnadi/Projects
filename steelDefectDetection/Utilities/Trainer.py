...
class Trainer(object):
    ...
    def __init__(self, model, lr, epochs, path):
        ...
        # torch.set_default_tensor_type("torch.cuda.FloatTensor")  # Try to comment because got error because of this
        self.net = model
    ...
    def provider(self,
        ...
        # train_df, val_df = train_test_split(df, test_size=0.3, stratify=df["Number_of_Defects"], random_state=69)  # Commented this one because of error
        train_df, val_df = train_test_split(df, test_size=0.3, random_state=69)
